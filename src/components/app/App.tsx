...
export const App = () => {
  ...
  return (
    <ThemeProvider theme={myTheme}>
      <Screen header={<Header>Some things I like</Header>} footer={lotties[lotties.length-1].footer} menu={isMenuOpen?<Icon as={Cross} onClick={()=>setIsMenuOpen(false)} />:<Icon as={Menu} onClick={()=>setIsMenuOpen(true)} />}>
        <CardsWrapper>
